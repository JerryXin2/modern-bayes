...
Y = t(matrix(c(23.1, 23.2, 22.9, 22.9, 22.8,22.7, 
        ...
        23.7,23.6,23.7,23.5,23.5,23.4), nrow = 4, ncol = 6))
...
```
Swimmer 2 has the lowest probability of having the largest recorded swim time, 0.15767(less than 0.21567, 0.366, 0.26167). Because Swimmer 2 is the lowest probability, the coach should send Swimmer 2 to compete in the competition because she has the lowest chance to come in last between the 4 swimmers(only a 15.767% chance to come in last).

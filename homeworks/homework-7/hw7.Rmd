...
ggplot(crab.df, aes(x = theta1, y = theta2)) +
  ...
  facet_wrap(~ species)
```
Looking at the plots of theta 1 and theta 2, we can see that on average, orange crabs seem to have a larger theta 1 value than blue crabs, and on average, orange crabs seem to have a larger theta 2 value than blue crabs.
```{r}

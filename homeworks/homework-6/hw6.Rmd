...
The Diagnostic Plots(Trace plots and running average plots) of 10,000 iterations both show that we have not run the sampler long enough, because the trace plots have relatively constant variance between 0 to 10,000 iterations, and the running average plots have flattened out/converged to one value and are not wavering between values, between 0 to 10,000 iterations. There seems to be no evidence that our sample diverges.
...
The Density plot of theta seems to be centered at the mean, which is represented by the vertical red line, as seems to follow the shape of a normal bellcurve.
The Density plot of z9 seems to be skewed right. The median is the best measure of center here. The median is lower than the mean, which is represented by the vertical red line. 
...
When r = 10, a = 1, and b = 100, the Density plot of theta has the same shape(normal bell-curve, gaussian), but is instead centered at 0.6. It was centered at around 3.2 when r = 10, a = 1, b = 1.

When r = 10, a = 1, and b = 100, the Density plot of z9 is more of a normal bellcurve shape when compared to the density plot when r = 10, a = 1, b = 1, but is instead centered at about 17. It was centered at around 3.2 when r = 10, a = 1, b = 1.

When r = 10, a = 100, and b = 1, the Density plot of theta has the same shape(normal bell-curve, gaussian), but is instead centered at around 7.2. It was centered at around 3.2 when r = 10, a = 1, b = 1.

When r = 10, a = 100, and b = 1, the Density plot of z9 is more skewed right when ompared to the density plot when r = 10, a = 1, b = 1, but is instead centered at around 2.25. It was centered at around 3.2 when r = 10, a = 1, b = 1.
